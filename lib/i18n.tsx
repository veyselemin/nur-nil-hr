...
const translations: Record<string, Record<Lang, string>> = {
  ...
  // ─── Dashboard Extended ───
  "dash.on_duty": { en: "On Duty Now", tr: "Şu An Görevde", ar: "في الخدمة الآن" },
  "dash.absent_today": { en: "Absent Today", tr: "Bugün Devamsız", ar: "غائب اليوم" },
  "dash.late_today": { en: "Late Today", tr: "Bugün Geç Gelen", ar: "متأخر اليوم" },
  "dash.pending_approvals": { en: "Pending Approvals", tr: "Bekleyen Onaylar", ar: "الموافقات المعلقة" },
  "dash.new_this_month": { en: "New This Month", tr: "Bu Ay Yeni", ar: "جديد هذا الشهر" },
  "dash.suspended": { en: "Suspended", tr: "Askıya Alınan", ar: "موقوف" },
  "dash.live_overview": { en: "Live overview · Auto-refreshes every 30 seconds", tr: "Canlı genel bakış · Her 30 saniyede otomatik yenilenir", ar: "نظرة عامة مباشرة · يتجدد تلقائيًا كل 30 ثانية" },
  "dash.shift_status": { en: "Shift Status", tr: "Vardiya Durumu", ar: "حالة الوردية" },
  "dash.shift_morning": { en: "Morning Shift", tr: "Sabah Vardiyası", ar: "وردية الصباح" },
  "dash.shift_afternoon": { en: "Afternoon Shift", tr: "Öğleden Sonra Vardiyası", ar: "وردية المساء" },
  "dash.shift_night": { en: "Night Shift", tr: "Gece Vardiyası", ar: "وردية الليل" },
  "dash.shift": { en: "Shift", tr: "Vardiya", ar: "وردية" },
  "dash.expected": { en: "expected", tr: "beklenen", ar: "متوقع" },
  "dash.live": { en: "LIVE", tr: "CANLI", ar: "مباشر" },
  "dash.active": { en: "ACTIVE", tr: "AKTİF", ar: "نشط" },
  "dash.factory_site_1": { en: "Factory Site 1", tr: "Fabrika 1. Bölge", ar: "موقع المصنع 1" },
  "dash.factory_site_2": { en: "Factory Site 2", tr: "Fabrika 2. Bölge", ar: "موقع المصنع 2" },
  "dash.on_duty_pct": { en: "on duty", tr: "görevde", ar: "في الخدمة" },
  "dash.of_total": { en: "of", tr: "/", ar: "من" },
  "dash.recent_approvals": { en: "Recent Approvals", tr: "Son Onaylar", ar: "الموافقات الأخيرة" },
  "dash.no_approvals": { en: "No pending approvals", tr: "Bekleyen onay yok", ar: "لا توجد موافقات معلقة" },
  "dash.hr_dashboard": { en: "HR Dashboard", tr: "İK Kontrol Paneli", ar: "لوحة تحكم الموارد البشرية" },
  // ─── Employee Detail ───
